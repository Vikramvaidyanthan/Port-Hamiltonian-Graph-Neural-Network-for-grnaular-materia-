...
async def shovel_sequence():
    ...
    keyframes = [
        ...
        ("lower_to_pile",   30, {sh0:  0.0,  sh1: -0.8,   el0: 1.7,   el1: 0.375, wr0: 0.192, wr1: 0}),
        ("scoop_open",   30, {sh0:  0.0,  sh1: -0.4,   el0: 1.3,   el1: 0.375, wr0: 0.192, wr1: 0}),
        ("scoop_close",     30, {sh0:  0.0,  sh1: -0.8,   el0: 1,   el1: 0.375, wr0: 0.192,   wr1: 0.}),
        ("straigthen",      30,  {sh0:  0.0,  sh1: -1.225, el0: 0.836, el1: 0.375, wr0: 0.192, wr1: 0}),
        ("drop_1",      30,  {sh0:  0.0,  sh1: -1.225, el0: 0.836, el1: 0.375, wr0: .75, wr1: 0}),
         ("drop_2",      30,  {sh0:  0.0,  sh1: -1.225, el0: 0.836, el1: 0.375, wr0: .75, wr1: 3.14}),
         ("drop_3",      30,  {sh0:  0.0,  sh1: -1.225, el0: 0.836, el1: 0.375, wr0: 1.2, wr1: 3.14})
