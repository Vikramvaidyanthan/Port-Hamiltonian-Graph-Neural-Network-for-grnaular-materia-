...
SAVE_DIR          = "/home/rllab_msc_student/Vikram/assets/Dataset"
# ────────────────────────────────────────────────────────
...
async def shovel_sequence():
    ...
    for loop_iter in range(NUM_LOOPS):
        ...
        keyframes = [
            # (name,              steps,  targets)
            # flat_start: no perturbation
            ("flat_start",      60,  {sh0:  0.0,                       sh1: -1.225, el0: 1.2, el1: 0.375, wr0: -0.192, wr1: 3.14}),
            ("lower_and_turn",  60,  {sh0:  0.4 + x_lower_and_turn,    sh1: -1.0,   el0: 2.2, el1: 0.375, wr0: -0.192, wr1: 3.14}),
            ("move_forward",    60,  {sh0:  0.4 + x_move_forward,      sh1:  0.05,  el0: 0.9, el1: 0.375, wr0: -0.5,   wr1: 3.14}),
            ("turn",            60,  {sh0:  0.0 + x_turn,              sh1:  0.3,   el0: 0.5, el1: 0.375, wr0: -0.5,   wr1: 3.14}),
            ("retract",         90,  {sh0:  0.0 + x_retract,           sh1: -1.0,   el0: 2.2, el1: 0.375, wr0: -0.192, wr1: 3.14}),
            ("turn_2",          60,  {sh0: -0.4 + x_turn_2,            sh1: -1.0,   el0: 2.2, el1: 0.375, wr0: -0.192, wr1: 3.14}),
            ("move_forward_2",  60,  {sh0: -0.4 + x_move_forward_2,    sh1:  0.05,  el0: 0.9, el1: 0.375, wr0: -0.5,   wr1: 3.14}),
            ("rise_1",          60,  {sh0: -0.4 + x_rise_1,            sh1: -1.225, el0: 1.2, el1: 0.375, wr0:  0.75,  wr1: 3.14}),
        ]
