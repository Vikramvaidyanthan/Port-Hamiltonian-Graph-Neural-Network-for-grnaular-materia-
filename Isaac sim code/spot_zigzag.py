...
async def shovel_sequence():
    ...
    keyframes = [
        ...
        ("Lower_and_turn",      60,  {sh0:  0.5,  sh1: -1, el0: 2.2, el1: 0.375, wr0: -0.192, wr1: 3.14}),
         ("Move_sideways",      60,  {sh0:  -0.4,  sh1: -1, el0: 2.2, el1: 0.375, wr0: -0.192, wr1: 3.14}),
          ("Move_Forward",      60,  {sh0:  -0.4,  sh1: -0.5, el0: 1.5, el1: 0.375, wr0: -0.192, wr1: 3.14}),
          ("Move_Sideways2",      60,  {sh0:  0.4,  sh1: -0.5, el0: 1.5, el1: 0.375, wr0: -0.192, wr1: 3.14}),
          ("Move_Forward2",      60,  {sh0:  0.4,  sh1: -0, el0: 1, el1: 0.375, wr0: -.5, wr1: 3.14}),
          ("Move_Sideways3",      60,  {sh0:  -0.4,  sh1: -0.1, el0: 1, el1: 0.375, wr0: -.5, wr1: 3.14}),
